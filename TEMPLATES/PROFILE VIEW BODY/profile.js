(function () {
  ...
  function initializeLitsoProfile() {
    ...
    if (
      !profile ||
      profile.getAttribute("data-litso-profile-ready") === "true"
    ) {
      return;
    }
    ...
    $(profile)
      ...
      .each(function () {
        ...
        if (!editable.is("span, div")) {
          return;
        }


        /* -----------------------------------------------
           APPARITION DU BOUTON D'ÉDITION
           ----------------------------------------------- */
        ...
        field.on(
          ...
          function () {
            ...
            if (
              field.find(".ajax-profil_edit").length
            ) {
              return;
            }
            ...
            editButton.on(
              ...
              function () {
                ...
                var validButton = $(
                  ...
                  {
                    type: "button",
                    class: "ajax-profil_valid",
                    title: "{L_VALIDATE}",
                    "aria-label": "{L_VALIDATE}"
                  }
                );
                ...
                validButton.on(
                  ...
                  function () {
                    ...
                    field
                      .find(".field_editable [name]")
                      .each(function () {

                        var input = $(this);

                        var special = input.is(
