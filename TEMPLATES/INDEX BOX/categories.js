(function () {
  ...
  function getForumKeyFromHref(href) {
  ...
  function initializeViewforumKicker() {
    var kickers = document.querySelectorAll(
      ".litso-viewforum_eyebrow"
    );
    ...
    var forumKey = getCurrentForumKey();
  ...
  function removeForumactifPostImages(meta) {
    ...
    var images = meta.querySelectorAll(
      "img"
    );
  ...
  function initializeLitsoForums() {

    initializeLitsoIndexBox();

    initializeViewforumKicker();
  }
